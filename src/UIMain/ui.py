...
frame1 = Frame(frame, bg = "blue").grid(row =0 , column = 0, padx = 1, pady=1, sticky="nsew")
frame2 = Frame(frame, bg = "red").grid(row =0 , column = 1, padx = 1, pady=1, sticky="nsew")
#frame3 = Frame(frame, bg = "red").grid(row =1 , column = 0, padx = 1, pady=1, sticky="nsew")
#frame4 = Frame(frame, bg = "blue").grid(row =1 , column = 1, padx = 1, pady=1, sticky="nsew")
