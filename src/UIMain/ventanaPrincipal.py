...
""", font=("Arial", 10))  # Cambiar la fuente a Arial y el tamaño a 12 puntos
        ...
        self.LabelDireccionDes2 = Label(self.frameDireccion2, text="En este apartado podrá cambiar su direccion de domicilio, primero escoja la ciudad donde está ubicado en el menú desplegable, luego ingrese su direccion especifica en los campos correspondientes, posteriormente presione Aceptar", wraplength=400)
        ...
        try:
            if self.comboBoxCalificar.get() == None or self.comboBoxCalificar.get() == "":
                ...
                if self.comboBoxCalificar.get() == "Domiciliario":
                    ...
                    Cliente.getSesion().notaCocineros(values[0])
